...
const report={version:'2.3.5',file:resolve('deliverables/20260925_GPTEchoCat新版DSH侧边栏兼容离线预览_V2.3.5.html'),liveDSH:false,requests:[],errors:[]};
try{
...
await page.click('.preview-sidebar-wide .ecp-sidebar-open');await page.waitForSelector('.ecp-final-dialog[open]');assert.equal(await page.$$eval('.ecp-final-dialog[open] .ecp-final-style',nodes=>nodes.length),15);await page.keyboard.press('Escape');
...
console.log('Standalone V2.3.5 file:// preview loaded with 15 styles, 9 layouts, DSH v0.1.7 sidebar compatibility and long-answer protection.');
